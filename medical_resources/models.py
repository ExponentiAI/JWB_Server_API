...
class SupAndDem(models.Model):   #供求表
    ...
    u_id = models.ForeignKey(UserInfo, on_delete=models.CASCADE, verbose_name='用户openID',related_name='u_id',default="")
...
#     t_id = models.IntegerField(primary_key=True, verbose_name='物资类型ID', unique=True)
